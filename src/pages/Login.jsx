...
function Login(props){
    ...
    // const setUsers = props.setUsers     --- because we dont use
    ...
    return(
        ...
        <div className="bg-[#EFEFEF] p-10 border rounded-md">
            ...
            {ruser?<p>I help you manage your activities after you login :)</p>:<p className="text-red-400">"Please Sigh Up Before you Login"</p> }
